...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare SQL query
    $sql = "INSERT INTO tickets (nombre_solicitante, direccion_solicitante, tipo_telefono, telefono, id_tipo_peticion, tipo_solicitante, direccion_problematica, problematica, colonia) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

    // Execute SQL query
    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param('sssisssss', $nombre_solicitante, $direccion_solicitante, $tipo_telefono, $telefono, $id_tipo_peticion, $tipo_solicitante, $direccion_problematica, $problematica, $colonia);
        if ($stmt->execute()) {
